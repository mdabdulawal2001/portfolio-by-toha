...
import logo from "../assets/maad1.png";
        ...
        <div className="hidden items-center gap-2 sm:flex">
          {navigationItems.map((item) => (
            <Link
              key={item.href}
              href={`#${item.href}`}
              className={`rounded-full px-4 py-2 text-sm font-medium transition ${activeSection === item.href ? "bg-slate-900 text-white shadow-sm dark:bg-sky-500 dark:text-slate-950" : "text-slate-700 hover:bg-slate-100 hover:text-slate-900 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-white"}`}
            >
              {item.label}
            </Link>
          ))}
          ...
          >
            ...
            {navigationItems.map((item) => (
              <Link
                key={item.href}
                href={`#${item.href}`}
                className={`mb-2 flex rounded-2xl px-4 py-3 text-base font-medium transition ${activeSection === item.href ? "bg-slate-900 text-white shadow-sm dark:bg-sky-500 dark:text-slate-950" : "text-slate-800 hover:bg-slate-100 dark:text-slate-200 dark:hover:bg-slate-800"}`}
